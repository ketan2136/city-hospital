...
//   const [menudata, setmanudta] = useState("Home")
...
//                   { <MailIcon />}
//                 </ListItemIcon>
//                 <ListItemText primary="appoiment" />
//               </ListItemButton>
//             </ListItem>
...
export default function MiniDrawer({children}) {
  ...
  return (
    <Box sx={{ display: 'flex',  }}>
      <CssBaseline />
      <AppBar position="fixed" sx={{backgroundColor:'red'}} open={open}>
        <Toolbar>
          <IconButton
            color="inherit"
            aria-label="open drawer"
          ...
          {Drowerdata.map((t, i) => (
            ...
            >
              ...
              >
                ...
                <ListItemText primary={t.labal} sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
          ))}
        </List>
